...
export class ThermalPrinter {
  ...
  private async niimbotPrint(text: string): Promise<void> {
    try {
      ...
      console.log(`📤 Step 6/8: Sending ${bitmap.data.length} bitmap rows...`);
      ...
      // 8. End print job
      console.log('📤 Step 8/8: End print job');
