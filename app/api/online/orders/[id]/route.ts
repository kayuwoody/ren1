 ...
 * Called by the POS to advance order status or toggle intake pause.
 *
 * Body variants:
 *   { "status": "accepted" }
 *   { "status": "rejected", "reject_reason": "out_of_stock" }
 *   { "intake_paused": true, "outlet_id": "main" }
 */
export async function PATCH(req: Request, { params }: Params) {
  ...
  // ── Intake pause toggle (no order ID needed, id is ignored) ──────────────
  ...
  // Decrement stock for limited-stock items on accept
