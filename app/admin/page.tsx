...
import { Shield, Package, Lock, Activity, AlertTriangle, DollarSign, Printer, ShoppingBag, ChefHat, Star, Receipt, Sparkles, Truck, ClipboardList, BarChart3 } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h2 className="text-xl font-semibold">Stock Usage</h2>
                </div>
                <p className="text-orange-50">Track all stock level changes and movements</p>
              </Link>
            </div>
          </div>
