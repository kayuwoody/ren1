...
const ProductListPage: React.FC = () => {
  ...
  return (
    <div className="w-full p-4">
      ...
      <div className="grid gap-3 grid-cols-[repeat(auto-fill,minmax(110px,1fr))] md:grid-cols-[repeat(auto-fill,minmax(150px,1fr))]">
        {filteredProducts.map(product => {
          ...
          >
            ...
            {/* Product info */}
            <div className="p-3">
              <h3 className="font-semibold text-sm md:text-base text-gray-900 mb-1 line-clamp-3 md:line-clamp-2 min-h-[2.5rem] md:min-h-[3rem]">{product.name}</h3>
              {/* Category tag */}
